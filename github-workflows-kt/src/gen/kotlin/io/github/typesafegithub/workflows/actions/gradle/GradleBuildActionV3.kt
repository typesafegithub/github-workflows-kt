...
public data class GradleBuildActionV3 private constructor(
     ...
     */
    public val develocityTokenExpiry: String? = null,
    /**
     * Enables Develocity injection.
     */
    public val develocityInjectionEnabled: String? = null,
    /**
     ...
     * using a self-signed.
     */
    public val develocityAllowUntrustedServer: String? = null,
    /**
     * Enables capturing the paths and content hashes of each individual input file.
     */
    public val develocityCaptureFileFingerprints: String? = null,
    /**
     ...
     */
    public val develocityEnforceUrl: String? = null,
    /**
    ...
    public constructor(
        ...
        develocityTokenExpiry: String? = null,
        develocityInjectionEnabled: String? = null,
        develocityUrl: String? = null,
        develocityAllowUntrustedServer: String? = null,
        develocityCaptureFileFingerprints: String? = null,
        develocityEnforceUrl: String? = null,
    ...
    override fun toYamlArguments(): LinkedHashMap<String, String> = linkedMapOf(
        *listOfNotNull(
            ...
            develocityTokenExpiry?.let { "develocity-token-expiry" to it },
            develocityInjectionEnabled?.let { "develocity-injection-enabled" to it },
            develocityUrl?.let { "develocity-url" to it },
            develocityAllowUntrustedServer?.let { "develocity-allow-untrusted-server" to it },
            develocityCaptureFileFingerprints?.let { "develocity-capture-file-fingerprints" to it },
            develocityEnforceUrl?.let { "develocity-enforce-url" to it },
