 ...
 * @param roleDurationSeconds Role duration in seconds (default: 6 hours, 1 hour for OIDC/specified
 * aws-session-token)
 ...
 * @param roleChaining Use existing credentials from the environment to assume a new role
 * @param inlineSessionPolicy Inline session policy
 * @param managedSessionPolicies List of managed session policies
...
) : RegularAction<ConfigureAwsCredentialsV2.Outputs>("aws-actions", "configure-aws-credentials",
        _customVersion ?: "v2") {
    public constructor(
