 ...
 * @param labelsToAddWhenUnstale A comma delimited list of labels to add when a stale issue or pull
 * request receives activity and has the stale-issue-label or stale-pr-label removed from it.
 * @param labelsToRemoveWhenUnstale A comma delimited list of labels to remove when a stale issue or
 * pull request receives activity and has the stale-issue-label or stale-pr-label removed from it.
...
) : RegularAction<StaleV5.Outputs>("actions", "stale", _customVersion ?: "v5") {
    public constructor(
        ...
        daysBeforePrStale: StaleV5.Days? = null,
        daysBeforeClose: Int? = null,
        daysBeforeIssueClose: StaleV5.Days? = null,
        daysBeforePrClose: StaleV5.Days? = null,
        staleIssueLabel: String? = null,
        closeIssueLabel: String? = null,
        exemptIssueLabels: List<String>? = null,
        closeIssueReason: StaleV5.CloseIssueReason? = null,
