 ...
 * @param dotnetQuality Optional quality of the build. The possible values are: daily, signed,
 ...
 * of the repo.
 * @param cache Optional input to enable caching of the NuGet global-packages folder
 * @param cacheDependencyPath Used to specify the path to a dependency file: packages.lock.json.
