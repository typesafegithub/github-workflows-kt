        ...
        context("RunnerType") {
            it("renders properly") {
                ...
                RunnerType
                    ...
                    .toYaml() shouldBe listOf("self-hosted")
                RunnerType
                    .selfHosted("test-label", "test-arch", "test-label")
                ...
                RunnerType
                    .Group("test-group", "test-label", "test-label-2", "test-label")
                    .toYaml() shouldBe
                    mapOf(
                        "group" to "test-group",
                ...
                RunnerType
                    .Labelled("test-label", "test-label-2", "test-label")
