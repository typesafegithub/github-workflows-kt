 ...
 */
@Deprecated(
    message = "This action has a newer major version: InstallNixActionV21",
    replaceWith = ReplaceWith("InstallNixActionV21"),
)
...
) : RegularAction<Action.Outputs>("cachix", "install-nix-action", _customVersion ?: "v19") {
    public constructor(
