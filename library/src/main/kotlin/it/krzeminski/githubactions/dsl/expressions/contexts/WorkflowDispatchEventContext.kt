...
public object WorkflowDispatchEventContextOrganization :
    ...
    public const val events_url: String = "github.event.organization.events_url"

    public const val hooks_url: String = "github.event.organization.hooks_url"

    public const val id: String = "github.event.organization.id"

    public const val issues_url: String = "github.event.organization.issues_url"

    public const val login: String = "github.event.organization.login"

    public const val members_url: String = "github.event.organization.members_url"

    public const val node_id: String = "github.event.organization.node_id"

    public const val public_members_url: String = "github.event.organization.public_members_url"

    public const val repos_url: String = "github.event.organization.repos_url"
...
public object WorkflowDispatchEventContextRepository : ExpressionContext("github.event.repository") {
    ...
    public const val is_template: String = "github.event.repository.is_template"
    ...
    public const val visibility: String = "github.event.repository.visibility"
