...
@file:DependsOn("io.github.typesafegithub:github-workflows-kt:2.1.2-SNAPSHOT")
@file:DependsOn("io.github.typesafegithub:action-updates-checker:2.1.2-SNAPSHOT")
