...
@file:DependsOn("io.github.typesafegithub:github-workflows-kt:3.3.1-SNAPSHOT")
@file:DependsOn("io.github.typesafegithub:action-updates-checker:3.3.1-SNAPSHOT")
