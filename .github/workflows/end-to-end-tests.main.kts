...
@file:DependsOn("io.github.typesafegithub:github-workflows-kt:4.0.1-SNAPSHOT")
@file:DependsOn("io.github.typesafegithub:action-updates-checker:4.0.1-SNAPSHOT")
