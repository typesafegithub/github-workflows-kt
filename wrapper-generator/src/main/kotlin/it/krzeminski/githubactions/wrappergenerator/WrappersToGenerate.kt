...
val wrappersToGenerate = listOf(
    ...
    WrapperRequest(
        ...
        mapOf(
            ...
            "push" to StringTyping, // nope, it's not a boolean
            "pathspec_error_handling" to EnumTyping(
                "PathSpecErrorHandling",
    ...
    WrapperRequest(
        ...
        mapOf(
            ...
            "cache-write-only" to StringTyping, // could be boolean but breaking change
            "gradle-home-cache-strict-match" to StringTyping, // could be boolean but breaking change
        ),
    ),
    WrapperRequest(
    ...
    WrapperRequest(
        ...
        mapOf(
            ...
            "docker_build_args" to StringTyping, // could be a list but breaking change
        )
    ),
...
val additionalWrappersToGenerate = listOf(
    WrapperRequest(
