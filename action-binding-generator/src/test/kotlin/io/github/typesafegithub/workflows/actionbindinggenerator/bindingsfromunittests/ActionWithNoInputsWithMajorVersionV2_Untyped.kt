...
public class ActionWithNoInputsWithMajorVersionV2_Untyped(
...
) : RegularAction<Action.Outputs>("john-smith", "action-with-no-inputs-with-major-version-v2", _customVersion ?: "v3") {
    init {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as ActionWithNoInputsWithMajorVersionV2_Untyped
    ...
    override fun toString(): String = buildString {
        append("ActionWithNoInputsWithMajorVersionV2_Untyped(")
    ...
    ): ActionWithNoInputsWithMajorVersionV2_Untyped = ActionWithNoInputsWithMajorVersionV2_Untyped(
