...
public data class ActionWithAllTypesOfInputsBindingV2 private constructor(
     ...
     * List of enums
     */
    public val listEnumsExpression: Expression<List<ActionWithAllTypesOfInputsBindingV2.MyEnum>>? =
            null,
    /**
     * List of enums
     */
    public val listEnumsExpressions: List<Expression<ActionWithAllTypesOfInputsBindingV2.MyEnum>>? =
            null,
    /**
...
) : RegularAction<ActionWithAllTypesOfInputsBindingV2.Outputs>("john-smith",
        "action-with-all-types-of-inputs-binding-v2", _customVersion ?: "v3") {
    init {
        ...
        require(listOfNotNull(listStrings, listStrings_Untyped, listStringsExpression,
                listStringsExpressions).size <= 1) {
        ...
        require(listOfNotNull(listInts, listInts_Untyped, listIntsExpression,
                listIntsExpressions).size <= 1) {
            "Only one of listInts, listInts_Untyped, listIntsExpression, and listIntsExpressions must be set, but not multiple"
        }

        require(listOfNotNull(listEnums, listEnums_Untyped, listEnumsExpression,
                listEnumsExpressions).size <= 1) {
            "Only one of listEnums, listEnums_Untyped, listEnumsExpression, and listEnumsExpressions must be set, but not multiple"
        }

        require(listOfNotNull(listIntSpecial, listIntSpecial_Untyped, listIntSpecialExpression,
                listIntSpecialExpressions).size <= 1) {
    ...
    public constructor(
        ...
        listIntSpecialExpression: Expression<List<ActionWithAllTypesOfInputsBindingV2.MyInt>>? =
                null,
        listIntSpecialExpressions: List<Expression<ActionWithAllTypesOfInputsBindingV2.MyInt>>? =
                null,
        _customInputs: Map<String, String> = mapOf(),
        _customVersion: String? = null,
    ) : this(fooBar = fooBar, fooBar_Untyped = fooBar_Untyped, fooBarExpression = fooBarExpression,
            bazGoo = bazGoo, bazGoo_Untyped = bazGoo_Untyped, bazGooExpression = bazGooExpression,
            binKin = binKin, binKin_Untyped = binKin_Untyped, binKinExpression = binKinExpression,
            intPint = intPint, intPint_Untyped = intPint_Untyped, intPintExpression =
            intPintExpression, floPint = floPint, floPint_Untyped = floPint_Untyped,
            floPintExpression = floPintExpression, finBin = finBin, finBin_Untyped = finBin_Untyped,
            finBinExpression = finBinExpression, gooZen = gooZen, gooZen_Untyped = gooZen_Untyped,
            gooZenExpression = gooZenExpression, bahEnum = bahEnum, bahEnum_Untyped =
            bahEnum_Untyped, bahEnumExpression = bahEnumExpression, listStrings = listStrings,
            listStrings_Untyped = listStrings_Untyped, listStringsExpression =
            listStringsExpression, listStringsExpressions = listStringsExpressions, listInts =
            listInts, listInts_Untyped = listInts_Untyped, listIntsExpression = listIntsExpression,
            listIntsExpressions = listIntsExpressions, listEnums = listEnums, listEnums_Untyped =
            listEnums_Untyped, listEnumsExpression = listEnumsExpression, listEnumsExpressions =
            listEnumsExpressions, listIntSpecial = listIntSpecial, listIntSpecial_Untyped =
            listIntSpecial_Untyped, listIntSpecialExpression = listIntSpecialExpression,
            listIntSpecialExpressions = listIntSpecialExpressions, _customInputs = _customInputs,
    ...
    override fun toYamlArguments(): LinkedHashMap<String, String> = linkedMapOf(
        *listOfNotNull(
            ...
            listStringsExpressions?.let { "list-strings" to it.joinToString(" ", transform =
            ...
            listIntsExpressions?.let { "list-ints" to it.joinToString(" ", transform =
                    Expression<*>::expressionString) },
            ...
            listEnumsExpressions?.let { "list-enums" to it.joinToString(" ", transform =
                    Expression<*>::expressionString) },
            ...
            listIntSpecialExpressions?.let { "list-int-special" to it.joinToString(" ", transform =
                    Expression<*>::expressionString) },
