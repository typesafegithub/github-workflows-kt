...
public data class ActionWithNoTypingsBindingV2_Untyped private constructor(
...
) : RegularAction<Action.Outputs>("john-smith", "action-with-no-typings-binding-v2", _customVersion
        ?: "v3") {
    init {
    ...
    ) : this(foo_Untyped = foo_Untyped, fooExpression = fooExpression, bar_Untyped = bar_Untyped,
            barExpression = barExpression, _customInputs = _customInputs, _customVersion =
            _customVersion)
