 ...
 */
public class ActionWithOutputsBindingV2(
...
) : RegularAction<ActionWithOutputsBindingV2.Outputs>("john-smith",
        "action-with-outputs-binding-v2", _customVersion ?: "v3") {
    init {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as ActionWithOutputsBindingV2
    ...
    override fun toString(): String = buildString {
        append("ActionWithOutputsBindingV2(")
    ...
    ): ActionWithOutputsBindingV2 = ActionWithOutputsBindingV2(
        fooBar = fooBar,
