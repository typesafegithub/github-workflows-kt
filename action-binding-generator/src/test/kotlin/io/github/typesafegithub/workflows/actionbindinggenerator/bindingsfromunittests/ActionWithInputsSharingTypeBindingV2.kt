...
public data class ActionWithInputsSharingTypeBindingV2 private constructor(
...
) : RegularAction<Action.Outputs>("john-smith", "action-with-inputs-sharing-type-binding-v2",
        _customVersion ?: "v3") {
    init {
    ...
    ) : this(fooOne = fooOne, fooOne_Untyped = fooOne_Untyped, fooOneExpression = fooOneExpression,
            fooTwo = fooTwo, fooTwo_Untyped = fooTwo_Untyped, fooTwoExpression = fooTwoExpression,
            fooThree = fooThree, fooThree_Untyped = fooThree_Untyped, fooThreeExpression =
            fooThreeExpression, _customInputs = _customInputs, _customVersion = _customVersion)
