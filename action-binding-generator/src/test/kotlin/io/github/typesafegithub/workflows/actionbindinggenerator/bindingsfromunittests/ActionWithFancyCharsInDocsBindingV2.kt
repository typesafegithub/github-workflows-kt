...
public data class ActionWithFancyCharsInDocsBindingV2 private constructor(
...
) : RegularAction<Action.Outputs>("john-smith", "action-with-fancy-chars-in-docs-binding-v2",
        _customVersion ?: "v3") {
    init {
        ...
        require(listOfNotNull(nestedKotlinComments, nestedKotlinComments_Untyped,
                nestedKotlinCommentsExpression).size <= 1) {
    ...
    public constructor(
        ...
        _customVersion: String? = null,
            ...
            nestedKotlinComments_Untyped, nestedKotlinCommentsExpression =
            nestedKotlinCommentsExpression, percent = percent, percent_Untyped = percent_Untyped,
            percentExpression = percentExpression, _customInputs = _customInputs, _customVersion =
            _customVersion)
