...
public class ActionWithNoInputsWithMinorVersionV2_Untyped(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as ActionWithNoInputsWithMinorVersionV2_Untyped
    ...
    override fun toString(): String = buildString {
        append("ActionWithNoInputsWithMinorVersionV2_Untyped(")
    ...
    ): ActionWithNoInputsWithMinorVersionV2_Untyped = ActionWithNoInputsWithMinorVersionV2_Untyped(
