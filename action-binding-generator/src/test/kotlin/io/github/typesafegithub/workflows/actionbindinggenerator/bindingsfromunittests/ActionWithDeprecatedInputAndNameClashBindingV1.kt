 ...
 *
 * [Action on
 * GitHub](https://github.com/john-smith/action-with-deprecated-input-and-name-clash-binding-v1)
 *
...
public data class ActionWithDeprecatedInputAndNameClashBindingV1 private constructor(
    ...
    public val _customVersion: String? = null,
        ...
        "action-with-deprecated-input-and-name-clash-binding-v1", _customVersion ?: "v2") {
    init {
