 ...
 */
public class ActionWithNoInputsWithMinorVersionV2(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as ActionWithNoInputsWithMinorVersionV2
    ...
    override fun toString(): String = buildString {
        append("ActionWithNoInputsWithMinorVersionV2(")
    ...
    ): ActionWithNoInputsWithMinorVersionV2 = ActionWithNoInputsWithMinorVersionV2(
