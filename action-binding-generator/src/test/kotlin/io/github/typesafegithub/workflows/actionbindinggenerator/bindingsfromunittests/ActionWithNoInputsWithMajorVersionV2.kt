 ...
 */
public class ActionWithNoInputsWithMajorVersionV2(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as ActionWithNoInputsWithMajorVersionV2
    ...
    override fun toString(): String = buildString {
        append("ActionWithNoInputsWithMajorVersionV2(")
    ...
    ): ActionWithNoInputsWithMajorVersionV2 = ActionWithNoInputsWithMajorVersionV2(
